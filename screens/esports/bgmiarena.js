...
const ArenaScreen = () => {
  ...
  const arenaData = [
    ...
    { name: 'Library', screen: 'Register', image: livik },
    { name: 'Hangar - TDM', screen: 'Register', image: livik },
    { name: 'Hangar - TGM', screen: 'Register', image: livik },
    { name: 'Hangar - Arena Training', screen: 'Register', image: livik },
    { name: 'Livik - Ultimate Arena', screen: 'Register', image: livik },
    { name: 'Erangel - Ultimate Arena', screen: 'Register', image: livik },
  ];
